...
class TestCreateOnAppendLayout(VisdomHTTPTestCase):
    ...
    def test_an_append_without_the_key_still_creates_an_unstyled_window(self):
        """Old clients are unaffected: no key, same empty layout as before."""
        self.append_scatter("made", layout={})
        self.assertEqual(self.layout_of("made"), {})
